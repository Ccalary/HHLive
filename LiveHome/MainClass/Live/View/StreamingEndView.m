...
- (void)initLeftView{
    ...
    _headerImageView.image = [UIImage imageNamed:@"msg_head"];
...
- (void)initRightView{
    ...
    _seeTextLabel = [self createLabelWithTitle:@"关注数" andFontSize:[UIFont systemFontOfSize:15*_rate] andTextColor:[UIColor whiteColor]];
    _seeNumLabel = [self createLabelWithTitle:@"1000" andFontSize:[UIFont boldSystemFontOfSize:20*_rate] andTextColor:[UIColor themeColor]];
    ...
    _popuNumLabel = [self createLabelWithTitle:@"20000" andFontSize:[UIFont boldSystemFontOfSize:20*_rate] andTextColor:[UIColor themeColor]];
    ...
    UIButton *qqBtn = [self creatButtonWithImageStr:@"s_qq_32x32" andTag:1000];
    UIButton *wexinBtn = [self creatButtonWithImageStr:@"s_weixin_32x32" andTag:1001];
    UIButton *friendsBtn = [self creatButtonWithImageStr:@"s_friends_32x32" andTag:1002];
