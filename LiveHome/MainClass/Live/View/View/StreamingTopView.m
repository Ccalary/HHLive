...
////数据填充
//- (void)setRoomInfoModel:(FindLiveRoomInfoModel *)roomInfoModel{
//    _roomInfoModel = roomInfoModel;
//    //头像
//    [_headerImageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",_roomInfoModel.userimage]] placeholderImage:[UIImage imageNamed:@"msg_head"]];
//    _nameLabel.text = _roomInfoModel.username ?: @"";
//    _roomNumLabel.text = [NSString stringWithFormat:@"房间号:%@",_roomInfoModel.roomno ?: @""];
//    [self fitLabelWidth:_roomNumLabel];
//    _roomNumLabel.x = self.frame.size.width - 10 - _roomNumLabel.width;
//    
//    [self refreshUIWithPopularNum:roomInfoModel.pcount];
//}
//
////刷新人气值
